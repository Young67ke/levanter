...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_858861d4bc4c5456592db2fbfb7b0ef7f'.trim(),
  DATABASE:
  ...
  GEMINI_API_KEY: (process.enconst { Sequelize } = require('sequelize')
const { existsSync } = require('fs')
const path = require('path')
const configPath = path.join(__dirname, './config.env')
const databasePath = path.join(__dirname, './database.db')
