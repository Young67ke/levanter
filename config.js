...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_83e07c26d63904bd18881adf5f32b1dc7').trim(),
  DATABASE:
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'young67ke',
  ...
  KOYEB_API: (process.env.KOYEB_API || '+254715476990').trim(),
